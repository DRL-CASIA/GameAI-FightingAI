...
public class BaseUtil {
	...
	public static final Action[] actionAirTH=
	...
	public static final Action[] actionGroundTH = new Action[] {
			...
			Action.CROUCH_GUARD,
			Action.FOR_JUMP,Action.FORWARD_WALK, Action.DASH,
			Action.STAND_FB,
			Action.THROW_B,
			Action.THROW_A,Action.STAND_A, Action.CROUCH_A, Action.CROUCH_B, Action.STAND_FA,
			Action.CROUCH_FA,  Action.STAND_D_DF_FA, Action.STAND_D_DF_FB,
			Action.STAND_F_D_DFB,
			Action.STAND_GUARD,
			Action.JUMP,  Action.BACK_JUMP,
